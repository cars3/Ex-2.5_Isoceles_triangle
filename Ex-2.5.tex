...
\begin{lstlisting}
https://github.com/cars3/Ex-2.5_Isoceles_triangle/blob/main/Diagram%20for%20Ex-2.5.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/cars3/Ex-2.5_Isoceles_triangle/
\end{lstlisting}

\section{Problem}
(vectors 2.5) Are the following points from the vertices of Isoceles triangle?\\
\begin{align}
...
$\vec{A}=\myvec{5\\-2},\vec{B}=\myvec{6\\4},\vec{C}=\myvec{7\\-2}$ $\vspace{1cm}$\\
 To find out whether the triangle formed is an isoceles triangle the distance formula can be used, the formula is -\\
\begin{flushleft}
...
\hbox{\hspace{-0.4cm} \includegraphics[scale=0.7]{fig0.png}}
\end{flushleft}
\end{document}